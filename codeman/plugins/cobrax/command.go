...
import (
	...
	"protoc-plugins/plugins/flags"
)

type Option func(*cobra.Command)

func WithRunE(runE func(*cobra.Command, []string) error) Option {
	return func(cmd *cobra.Command) { cmd.RunE = runE }
}

func WithRun(run func(*cobra.Command, []string)) Option {
	return func(cmd *cobra.Command) { cmd.Run = run }
}

func WithArgs(arg cobra.PositionalArgs) Option {
	return func(command *cobra.Command) { command.Args = arg }
}

func WithHidden() Option {
	return func(command *cobra.Command) { command.Hidden = true }
}

func WithArgs(args []string) Option {
	return func(command *cobra.Command) { command.SetArgs(args) }
}
